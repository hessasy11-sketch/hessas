...
import { QrCode, Shield, CheckCircle2, User, Loader2, Camera, Upload } from 'lucide-react';
...
export function AdminSmartAccessGateV2() {
  ...
  const [accessMethod, setAccessMethod] = useState<AccessMethod>('camera');
