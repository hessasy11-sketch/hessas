...
import ScenarioGeneratorView from './ScenarioGeneratorView';
...
type TabType = 'overview' | 'dashboard' | 'scenarios' | 'alerts' | 'reports';
  ...
  return (
    <PageGuard platformRole={platformRole} pageKey="hq">
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900" dir="rtl">
        ...
        {activeTab === 'scenarios' && <ScenarioGeneratorView />}
