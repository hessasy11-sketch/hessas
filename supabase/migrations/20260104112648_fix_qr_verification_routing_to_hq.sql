/*
  # إصلاح توجيه QR للمدير العام
  
  1. التحديثات:
    - تغيير المسار من /hq-dashboard إلى /hq
    - هذا هو المسار الصحيح في App.tsx
  
  2. المخرجات:
    - landing_route: /hq للمديرين
*/
...
COMMENT ON FUNCTION verify_qr_access IS 'التحقق من QR مع التوجيه الصحيح للوحة الإدارة العليا /hq';
