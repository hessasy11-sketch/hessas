/*
  # السماح لـ service_role بالوصول لدوال لوحة القرار
  
  تحديث جميع الدوال للسماح بـ service_role
*/

-- =====================================================
-- 1️⃣ تحديث: دالة حساب حالة B2F
-- =====================================================
...
BEGIN
  ...
  -- التحقق من الصلاحية (تخطي التحقق إذا كان null - service_role)
...
-- =====================================================
-- 3️⃣ تحديث: دالة المؤشرات القيادية
-- =====================================================
...
-- =====================================================
-- 4️⃣ تحديث: دالة شريط النبض العام
-- =====================================================
...
-- =====================================================
-- 5️⃣ تحديث: دالة لوحة القرار الكاملة
-- =====================================================
