/*
  # إصلاح نهائي لدالة issue_contract_from_finance2
  
  المشكلة:
  - الدالة لا زالت تحتوي على investor_name في INSERT
  
  الحل:
  - إزالة جميع الأعمدة غير الموجودة في b2f_contracts
  - التأكد من عدم وجود investor_name, farm_name, duration_months, tree_type
*/
...
BEGIN
  ...
  -- 5. إنشاء العقد (فقط الأعمدة الموجودة في b2f_contracts)
