/*
  # تصحيح trigger ولادة المزرعة - استخدام reference_farm_id

  1. التغييرات
    - تحديث الدالة لاستخدام reference_farm_id بدلاً من farm_id
    - الجدول fc_operational_farms يستخدم reference_farm_id
*/

-- تحديث الدالة لاستخدام الحقل الصحيح
...
-- تحديث دالة get_operational_farm_for_farm أيضاً
...
BEGIN
  ...
  WHERE of.reference_farm_id = p_farm_id
  LIMIT 1;
END;
$$;