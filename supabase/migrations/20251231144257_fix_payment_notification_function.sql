/*
  # إصلاح دالة إشعارات السداد
  
  ## المشكلة:
  - الدالة تحاول استخدام investor_phone في جدول b2f_notifications
  - الجدول يستخدم investor_account_id وليس investor_phone
  
  ## الحل:
  - تحديث الدالة لاستخدام investor_account_id
  - الحصول على investor_account_id من investor_phone
*/
