/*
  # إصلاح دالة get_executive_pulse_finance - استخدام الجداول الموجودة
  
  ## المشكلة
  الدالة تبحث عن جدول operation_fees غير موجود
  
  ## الحل
  استخدام الجداول الموجودة فعلياً:
  - b2f_sales_requests للمدفوعات
  - farm_expenses للمصروفات
  
  ## التغييرات
  1. استبدال operation_fees بـ farm_expenses
  2. تبسيط الحسابات للعمل مع البيانات المتوفرة
*/

-- ============================================
-- إصلاح دالة المؤشرات المالية - النسخة النهائية
-- ============================================
...
BEGIN
  ...
  -- إجمالي المصروفات اليوم (من farm_expenses إن وجد)
