/*
  # إصلاح دالة issue_contract_from_finance2 - إزالة التسجيل المالي
  
  المشكلة:
  - الدالة تحاول التسجيل في b2f_financial_operations_log
  - باستخدام operation_type = 'contract_issued'
  - لكن هذه القيمة غير مسموحة في constraint
  
  الحل:
  - إزالة التسجيل في b2f_financial_operations_log
  - إصدار العقد ليس عملية مالية بحد ذاته
  - العمليات المالية تمت في خطوة اعتماد السداد
*/
...
BEGIN
  ...
  -- 8. إرسال إشعار للمستثمر (اختياري)
  BEGIN
