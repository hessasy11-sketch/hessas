/*
  # إصلاح التحقق من الرقم السري المشفر

  1. المشكلة
    - verify_staff_pin يقارن النص مباشرة بدلاً من استخدام crypt
    - الرمز السري مشفر لكن المقارنة لا تستخدم دالة فك التشفير

  2. الحل
    - استخدام crypt(p_pin_code, v_staff_record.pin_code) للمقارنة
    - تحديث المسار الافتراضي حسب الدور
*/
