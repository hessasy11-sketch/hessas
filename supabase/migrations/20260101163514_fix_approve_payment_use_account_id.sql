/*
  # إصلاح دالة approve_payment_document - استخدام investor_account_id
  
  المشكلة الحقيقية:
  - جدول b2f_notifications يستخدم investor_account_id وليس investor_phone
  - يجب ربط الإشعار بـ investor_account_id من b2f_sales_requests
  
  الحل: استخدام investor_account_id بدلاً من investor_phone
*/
...
-- دالة لرفض المستند المالي (مع تصحيح investor_account_id)
