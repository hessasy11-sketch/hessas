/*
  # إصلاح دالة approve_payment_document - تخطي الإشعار إذا لم يكن هناك حساب
  
  المشكلة:
  - إرسال إشعار يفشل إذا لم يكن investor_account_id موجود
  - يجب تخطي الإشعار في هذه الحالة
  
  الحل: الإشعار اختياري فقط إذا كان investor_account_id موجود
*/
...
BEGIN
  ...
  -- إرسال إشعار فقط إذا كان للمستثمر حساب مُسجل
