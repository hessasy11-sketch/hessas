/*
  # Fix get_my_work - Remove decision_queue (table doesn't exist with those columns)
  
  1. Changes
    - Focus on staff_tasks and farm_tasks only
    - Remove decision_queue references
*/
...
BEGIN
  ...
  -- ============================================
  -- 2. APPROVALS (Farm tasks awaiting approval only)
  -- ============================================
