/*
  # إصلاح توجيه المدير العام إلى لوحة الإدارة العليا

  1. Changes
    - تحديث دالة verify_qr_access لتوجيه super_admin إلى /hq
    - توجيه باقي الأقسام حسب اختصاصها
    - B2F → /b2f
    - باقي الأقسام → /
*/
