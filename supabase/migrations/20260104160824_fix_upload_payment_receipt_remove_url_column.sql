/*
  # إصلاح دالة upload_payment_receipt - إزالة عمود payment_receipt_url

  1. المشكلة:
    - الدالة تحاول تحديث عمود payment_receipt_url غير الموجود
    - جدول b2f_sales_requests لا يحتوي على هذا العمود

  2. الحل:
    - إزالة محاولة تحديث payment_receipt_url
    - تحديث receipt_uploaded_at فقط مع حالة الطلب
*/
